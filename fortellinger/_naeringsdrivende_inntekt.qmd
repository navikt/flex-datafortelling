...
```{python}
from fortellinger.naeringsdrivende_inntekt import fortelling_om_inntektssporsmal, finn_antall_svar_for_tags_med_periode
from oppsett.bigquery import init_bigquery_client

bq_client = init_bigquery_client()
finn_antall_svar_for_tags_med_periode = finn_antall_svar_for_tags_med_periode(bq_client)
data_inntektsp_foer = fortelling_om_inntektssporsmal(finn_antall_svar_for_tags_med_periode, 'foer')
data_inntektsp_etter = fortelling_om_inntektssporsmal(finn_antall_svar_for_tags_med_periode, 'etter')
...
graf_foer_etter_endring(finn_antall_svar_for_tags_med_periode)
